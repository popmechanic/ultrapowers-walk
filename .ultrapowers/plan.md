...
**Claim:** I can import countVowels from its own module and see `'Ada Lovelace'` become `6`, and
...
**Claim:** I can import countVowels from its own module and see 'Ada Lovelace' become 6, and the README table lists it. (quoted from #9)
Machine: M1. `countVowels('Ada Lovelace')` is `6` and `countVowels('rhythm')` is `0` — the
...
**Proof:**
- Test: `tests/vowels.test.ts`
- Legs: (a) `countVowels('Ada Lovelace')` equals `6` and `countVowels('rhythm')` equals `0` — a
